      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold text-my-custom-blue-dark">ORIGIN ROASTERS</h2>
            ...
            <form className="mt-4 flex max-w-md" onSubmit={(e) => e.preventDefault()}>
              ...
              <button type="submit" className="bg-my-custom-blue-dark text-black px-4 py-2 rounded-r-md font-medium">Subscribe</button>
            </form>
          </div>
