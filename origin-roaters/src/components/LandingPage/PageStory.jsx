...
const PageStory = () => {
  return (
    <div className='flex flex-row justify-center items-center h-screen'>
      <div>
        <h1 className='product-story-heading'>From our roastery to your morning ritual in three easy steps</h1>
        <p className='product-story-pargh'>Explore our collection of specialty beans from across 
         ...
         <p>Your order triggers a fresh roast in our Nairobi 
            roastery. We roast in small batches to ensure peak 
            flavor and quality.
         </p> <br/>

         <p>Your coffee is packaged and delivered within 48 hours. 
